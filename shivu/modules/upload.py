...
rarity_map = 1 (⚪Common), 2 (🟣 Rare) , 3 (🟢 Medium), 4 (🟡 Legendary), 5 (💮 Special Edition), 6 (🔮 Limited Edition), 7 (🎐 Celestial Beauty), 8 (), 9(💞𝐕𝐚𝐥𝐞𝐧𝐭𝐢𝐧𝐞), 10(🌲𝐂𝐡𝐫𝐢𝐬𝐭𝐦𝐚𝐬), 11(👶𝐂𝐡𝐢𝐛𝐢), 12(🐰𝐁𝐮𝐧𝐧𝐲), 13(🩺𝐍𝐮𝐫𝐬𝐞), 14(🩺𝐃𝐨𝐜𝐭𝐨𝐫), 15(🏖️𝐒𝐮𝐦𝐦𝐞𝐫), 16(🎒𝐒𝐜𝐡𝐨𝐨𝐥), 17(⚽𝐒𝐩𝐨𝐫𝐭𝐬), 18(🍻𝐁𝐚𝐫), 19(🎭𝐂𝐨𝐬𝐩𝐥𝐚𝐲), 20(🎀𝐒𝐮𝐫𝐩𝐫𝐢𝐬𝐞)"""
